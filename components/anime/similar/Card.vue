...
<template>
    <div>
        <a-card size="small" :bordered="false" class="w-[150px] bg-black text-white">
            ...
            <div class="flex justify-between items-center gap-1">
                <h2 class="font-bold text-white text-xl line-clamp-1 w-full">
                    {{ similar.russian }}
                </h2>
            ...
            <div class="flex gap-4 items-center justify-between">
                <div class="flex flex-row gap-2 items-center">
                    ...
                    <p class="text-base text-white font-bold">
                        {{ similar.episodes || similar.episodes_aired }}
                    </p>
                </div>
                <div class="flex flex-row gap-2 items-center">
                    <svg
